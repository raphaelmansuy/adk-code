...
// New code should use the XML-structured prompt generator (prompts/builder.go)
// which provides XML-structured tags that LLMs can parse more effectively.
...
// Deprecated: Use PromptBuilder.renderToolsXML() for XML-structured output
...
// Deprecated: Use BuildEnhancedPromptWithContext() from prompts/builder.go for XML-structured prompts
