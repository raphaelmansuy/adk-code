// Package events handles event display and processing
package events
...
import (
	...
	"code_agent/internal/display/tools"
	"code_agent/tracking"

	"google.golang.org/adk/session"
)

// Re-export types for use in this package
type (
	Renderer         = rdr.Renderer
	StreamingDisplay = streaming.StreamingDisplay
	Spinner          = components.Spinner
	EventTimeline    = components.EventTimeline
	SpinnerMode      = components.SpinnerMode
	ToolRenderer     = tools.ToolRenderer
	ToolResultParser = tools.ToolResultParser
	EventType        = components.EventType
)

// Re-export constants
const (
	SpinnerModeThinking = components.SpinnerModeThinking
	SpinnerModeTool     = components.SpinnerModeTool
...
var (
	...
	NewToolRenderer     = tools.NewToolRenderer
	NewToolResultParser = tools.NewToolResultParser
)
