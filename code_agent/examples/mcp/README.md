...
This directory contains example MCP (Model Context Protocol) server configurations for the code_agent.
...
To verify code_agent works without MCP servers:
...
# Run code_agent with the MCP server
...
- See `../features/mcp_support_code_agent/README.md` for the full roadmap
