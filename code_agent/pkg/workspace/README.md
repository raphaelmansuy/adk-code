...
The `workspace` package provides sophisticated workspace management for the code_agent, including multi-root workspace support, VCS detection, and intelligent path resolution.
