...
// Package model provides wrapper functions for creating LLM models with different backends
package model
...
func CreateVertexAIModel(ctx context.Context, cfg VertexAIConfig) (model.LLM, error) {
	if cfg.Project == "" {
...
func CreateGeminiModel(ctx context.Context, cfg GeminiConfig) (model.LLM, error) {
	if cfg.APIKey == "" {
