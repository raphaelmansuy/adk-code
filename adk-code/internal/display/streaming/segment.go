...
import (
	...
	"adk-code/internal/display/terminal"
)

// Re-export types we depend on
type (
	MarkdownRenderer  = rdr.MarkdownRenderer
	TypewriterPrinter = components.TypewriterPrinter
)
...
// IsTTY wraps the terminal check
func IsTTY() bool {
